    ...
    <tr>
      ...
      <td>
        <center>
          ...
          <a onclick="return confirm('Yakin Menghapus Data Ini?')" class="btn btn-sm btn-danger" href="<?= base_url('admin/dataJabatan/deleteData/'.$j->id_jabatan); ?>"><i class="fas fa-trash"></i></a>
        </center>
      </td>
    </tr>
    <?php endforeach; ?>

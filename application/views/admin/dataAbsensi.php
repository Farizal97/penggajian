...
<table class=" table table-bordered table-striped">
  ...
  <?php $no=1; foreach ($absensi as $abs) : ?>
    <tr>
      ...
      <td><?php echo $abs->nama_pegawai ?></td>
      <td><?php echo $abs->jenis_kelamin ?></td>
      <td><?php echo $abs->nama_jabatan ?></td>
      <td><?php echo $abs->hadir ?></td>
      <td><?php echo $abs->sakit ?></td>
      <td><?php echo $abs->alpha ?></td>
    </tr>
  <?php endforeach ?>

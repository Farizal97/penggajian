...
<div class="container-fluid" style="min-height: 700px;">
  ...
  <form action="" method="post">
    ...
    <table class="table table-bordered table-striped">
      ...
      <?php
      $no = 1;
      foreach($inputAbsensi as $abs): ?>
      <tr>
        <input type="hidden" name="bulan[]" class="form-control" value="<?= $bulanTahun; ?>">
        <input type="hidden" name="nik[]" class="form-control" value="<?= $abs->nik; ?>">
        <input type="hidden" name="nama_pegawai[]" class="form-control" value="<?= $abs->nama_pegawai; ?>">
        <input type="hidden" name="jenis_kelamin[]" class="form-control" value="<?= $abs->jenis_kelamin; ?>">
        <input type="hidden" name="nama_jabatan[]" class="form-control" value="<?= $abs->nama_jabatan; ?>">
